...
public class BreakfastActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        breakfast_List = (RecyclerView)findViewById(R.id.breakfast_recyclerview);
        breakfast_List.setHasFixedSize(true);
        breakfast_List.setLayoutManager(new LinearLayoutManager(BreakfastActivity.this));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if(item.getItemId() == R.id.action_account){
            ...
            intent = new Intent(BreakfastActivity.this, AccountActivity.class);
            startActivity(intent);
        }
        if(item.getItemId() == R.id.action_search){

            intent = new Intent(BreakfastActivity.this, SearchActivity.class);
            startActivity(intent);
        }
        if(item.getItemId() == R.id.action_feedback){

            intent = new Intent(BreakfastActivity.this, FeedbackActivity.class);
            startActivity(intent);
        }
